...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:value-of select="'Total pronoun usage by women:', count($interviews[//interviewee/@ref = $index//person[.//gender/text() = 'f']/@xml:id]//pron), '&#10;'"/>
        <xsl:value-of select="'Total pronoun usage by men:', count($interviews[//interviewee/@ref = $index//person[.//gender/text() = 'm']/@xml:id]//pron), '&#10;'"/>
